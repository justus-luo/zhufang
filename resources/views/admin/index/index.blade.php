...
<header class="navbar-wrapper">
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl"><a class="logo navbar-logo f-l mr-10 hidden-xs" href="#">租房</a>
                ...
                <ul class="cl">
                    ...
                    <li class="dropDown dropDown_hover">
                        ...
                        <ul class="dropDown-menu menu radius box-shadow">
                            <li><a href="javascript:;" onClick="myselfinfo()">{{auth()->user()->username}}</a></li>
                            <li><a href="#">切换账户</a></li>
...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        @foreach($menuData as $menu)
            <dl id="menu-admin">
                <dt><i class="Hui-iconfont">&#xe62d;</i> {{$menu['name']}}<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i>
                </dt>
                <dd>
                    <ul>
                        @foreach($menu['sub'] as $submenu)
                            <li><a data-href="{{ route($submenu['route_name']) }}" data-title="{{$submenu['name']}}"
                                   href="javascript:void(0)">{{$submenu['name']}}</a>
                            </li>
                        @endforeach
                    </ul>
                </dd>
